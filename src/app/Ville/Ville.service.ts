...
export class VilleService {
  private baseURL3 = "http://localhost:8089/villes";
  private baseURL = "http://localhost:8089/villes/all";
  private baseURL2 = "http://localhost:8080/Electricite/allCond";
  private baseURL1 = "http://localhost:8080/User/getUser";
  private baseURL4 = "http://localhost:8089/villes";
  private baseURL5 = "http://localhost:8080/Elect/bills";
  private baseURL6 = "http://localhost:8089/villes/addVille";
